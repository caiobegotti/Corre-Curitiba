...
public class EventsParser {
	...
	public final static String MAP_KEY = "Mapa (Link):";
	...
	public List<Event> listFromJSON(String json) throws JSONException {
		...
		while(id.hasNext()){
			...
			if (eventJson.has(MAP_KEY)) {
				map = eventJson.getString(MAP_KEY);
			}

			events.add(new Event(name, description, date, distance, local, url, enrollmentUrl, enrollmentDate, map));
		}
